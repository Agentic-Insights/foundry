...
## Applying These Principles in Code Generation

When this skill generates BAML code, it applies these principles:

1. **Schema-first generation** - Types are generated before functions
2. **@description on every field** - Guides LLM behavior through the schema
3. **Union types for tool calling** - Not API-level tool binding
4. **@assert/@check validation** - Production constraints built into types
